...
import com.exrates.inout.dao.YandexMoneyMerchantDao;
...
public class YandexMoneyMerchantDaoImpl implements YandexMoneyMerchantDao {
    ...
    public static final RowMapper<String> tokenRowMapper = (resultSet, i) -> resultSet.getString("access_token");
    ...
    public String getTokenByUserEmail(String userEmail) {
        ...
        try {
            return new NamedParameterJdbcTemplate(dataSource).queryForObject(sql, params, tokenRowMapper);
