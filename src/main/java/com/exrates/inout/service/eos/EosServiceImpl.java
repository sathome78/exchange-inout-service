...
public class EosServiceImpl implements EosService {
    ...
    @Autowired
    public EosServiceImpl(CryptoCurrencyProperties ccp){
        this.eosProperty = ccp.getEosCoins().getEos();
    }

    @Override
    public String getMainAddress(){
        return eosProperty.getEosMainAddress();
    }
    ...
    public Map<String, String> refill(RefillRequestCreateDto request) {
        ...
        String message = messageSource.getMessage("merchants.refill.xlm",
                new Object[]{eosProperty.getEosMainAddress(), destinationTag}, request.getLocale());
        return new HashMap<String, String>() {{
            put("address", destinationTag);
            put("message", message);
            put("qr", eosProperty.getEosMainAddress());
        }};
    }
    ...
    public boolean isValidDestinationAddress(String address) {
        return withdrawUtils.isValidDestinationAddress(eosProperty.getEosMainAddress(), address);
    }
