...
public final class MessageVerificationServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.exrates.inout.service.decred.grpc.MessageVerificationService";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  @java.lang.Deprecated // Use {@link #getVerifyMessageMethod()} instead. 
  public static final io.grpc.MethodDescriptor<com.exrates.inout.service.decred.grpc.DecredApi.VerifyMessageRequest,
      com.exrates.inout.service.decred.grpc.DecredApi.VerifyMessageResponse> METHOD_VERIFY_MESSAGE = getVerifyMessageMethodHelper();

  private static volatile io.grpc.MethodDescriptor<com.exrates.inout.service.decred.grpc.DecredApi.VerifyMessageRequest,
      com.exrates.inout.service.decred.grpc.DecredApi.VerifyMessageResponse> getVerifyMessageMethod;

  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<com.exrates.inout.service.decred.grpc.DecredApi.VerifyMessageRequest,
      com.exrates.inout.service.decred.grpc.DecredApi.VerifyMessageResponse> getVerifyMessageMethod() {
    return getVerifyMessageMethodHelper();
  }

  private static io.grpc.MethodDescriptor<com.exrates.inout.service.decred.grpc.DecredApi.VerifyMessageRequest,
      com.exrates.inout.service.decred.grpc.DecredApi.VerifyMessageResponse> getVerifyMessageMethodHelper() {
    io.grpc.MethodDescriptor<com.exrates.inout.service.decred.grpc.DecredApi.VerifyMessageRequest, com.exrates.inout.service.decred.grpc.DecredApi.VerifyMessageResponse> getVerifyMessageMethod;
      ...
      synchronized (MessageVerificationServiceGrpc.class) {
        if ((getVerifyMessageMethod = MessageVerificationServiceGrpc.getVerifyMessageMethod) == null) {
          MessageVerificationServiceGrpc.getVerifyMessageMethod = getVerifyMessageMethod = 
              io.grpc.MethodDescriptor.<com.exrates.inout.service.decred.grpc.DecredApi.VerifyMessageRequest, com.exrates.inout.service.decred.grpc.DecredApi.VerifyMessageResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "com.exrates.inout.service.decred.grpc.MessageVerificationService", "VerifyMessage"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.exrates.inout.service.decred.grpc.DecredApi.VerifyMessageRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.exrates.inout.service.decred.grpc.DecredApi.VerifyMessageResponse.getDefaultInstance()))
  ...
  public static abstract class MessageVerificationServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void verifyMessage(com.exrates.inout.service.decred.grpc.DecredApi.VerifyMessageRequest request,
        io.grpc.stub.StreamObserver<com.exrates.inout.service.decred.grpc.DecredApi.VerifyMessageResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.exrates.inout.service.decred.grpc.DecredApi.VerifyMessageRequest,
                com.exrates.inout.service.decred.grpc.DecredApi.VerifyMessageResponse>(
  ...
  public static final class MessageVerificationServiceBlockingStub extends io.grpc.stub.AbstractStub<MessageVerificationServiceBlockingStub> {
    ...
    /**
     */
    public com.exrates.inout.service.decred.grpc.DecredApi.VerifyMessageResponse verifyMessage(com.exrates.inout.service.decred.grpc.DecredApi.VerifyMessageRequest request) {
  ...
  public static final class MessageVerificationServiceFutureStub extends io.grpc.stub.AbstractStub<MessageVerificationServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.exrates.inout.service.decred.grpc.DecredApi.VerifyMessageResponse> verifyMessage(
        com.exrates.inout.service.decred.grpc.DecredApi.VerifyMessageRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_VERIFY_MESSAGE:
          serviceImpl.verifyMessage((com.exrates.inout.service.decred.grpc.DecredApi.VerifyMessageRequest) request,
              (io.grpc.stub.StreamObserver<com.exrates.inout.service.decred.grpc.DecredApi.VerifyMessageResponse>) responseObserver);
          break;
        default:
