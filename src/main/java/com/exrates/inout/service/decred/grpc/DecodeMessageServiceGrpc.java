...
public final class DecodeMessageServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.exrates.inout.service.decred.grpc.DecodeMessageService";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  @java.lang.Deprecated // Use {@link #getDecodeRawTransactionMethod()} instead. 
  public static final io.grpc.MethodDescriptor<com.exrates.inout.service.decred.grpc.DecredApi.DecodeRawTransactionRequest,
      com.exrates.inout.service.decred.grpc.DecredApi.DecodeRawTransactionResponse> METHOD_DECODE_RAW_TRANSACTION = getDecodeRawTransactionMethodHelper();

  private static volatile io.grpc.MethodDescriptor<com.exrates.inout.service.decred.grpc.DecredApi.DecodeRawTransactionRequest,
      com.exrates.inout.service.decred.grpc.DecredApi.DecodeRawTransactionResponse> getDecodeRawTransactionMethod;

  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<com.exrates.inout.service.decred.grpc.DecredApi.DecodeRawTransactionRequest,
      com.exrates.inout.service.decred.grpc.DecredApi.DecodeRawTransactionResponse> getDecodeRawTransactionMethod() {
    return getDecodeRawTransactionMethodHelper();
  }

  private static io.grpc.MethodDescriptor<com.exrates.inout.service.decred.grpc.DecredApi.DecodeRawTransactionRequest,
      com.exrates.inout.service.decred.grpc.DecredApi.DecodeRawTransactionResponse> getDecodeRawTransactionMethodHelper() {
    io.grpc.MethodDescriptor<com.exrates.inout.service.decred.grpc.DecredApi.DecodeRawTransactionRequest, com.exrates.inout.service.decred.grpc.DecredApi.DecodeRawTransactionResponse> getDecodeRawTransactionMethod;
      ...
      synchronized (DecodeMessageServiceGrpc.class) {
        if ((getDecodeRawTransactionMethod = DecodeMessageServiceGrpc.getDecodeRawTransactionMethod) == null) {
          DecodeMessageServiceGrpc.getDecodeRawTransactionMethod = getDecodeRawTransactionMethod = 
              io.grpc.MethodDescriptor.<com.exrates.inout.service.decred.grpc.DecredApi.DecodeRawTransactionRequest, com.exrates.inout.service.decred.grpc.DecredApi.DecodeRawTransactionResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "com.exrates.inout.service.decred.grpc.DecodeMessageService", "DecodeRawTransaction"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.exrates.inout.service.decred.grpc.DecredApi.DecodeRawTransactionRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.exrates.inout.service.decred.grpc.DecredApi.DecodeRawTransactionResponse.getDefaultInstance()))
  ...
  public static abstract class DecodeMessageServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void decodeRawTransaction(com.exrates.inout.service.decred.grpc.DecredApi.DecodeRawTransactionRequest request,
        io.grpc.stub.StreamObserver<com.exrates.inout.service.decred.grpc.DecredApi.DecodeRawTransactionResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.exrates.inout.service.decred.grpc.DecredApi.DecodeRawTransactionRequest,
                com.exrates.inout.service.decred.grpc.DecredApi.DecodeRawTransactionResponse>(
  ...
  public static final class DecodeMessageServiceBlockingStub extends io.grpc.stub.AbstractStub<DecodeMessageServiceBlockingStub> {
    ...
    /**
     */
    public com.exrates.inout.service.decred.grpc.DecredApi.DecodeRawTransactionResponse decodeRawTransaction(com.exrates.inout.service.decred.grpc.DecredApi.DecodeRawTransactionRequest request) {
  ...
  public static final class DecodeMessageServiceFutureStub extends io.grpc.stub.AbstractStub<DecodeMessageServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.exrates.inout.service.decred.grpc.DecredApi.DecodeRawTransactionResponse> decodeRawTransaction(
        com.exrates.inout.service.decred.grpc.DecredApi.DecodeRawTransactionRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_DECODE_RAW_TRANSACTION:
          serviceImpl.decodeRawTransaction((com.exrates.inout.service.decred.grpc.DecredApi.DecodeRawTransactionRequest) request,
              (io.grpc.stub.StreamObserver<com.exrates.inout.service.decred.grpc.DecredApi.DecodeRawTransactionResponse>) responseObserver);
          break;
        default:
