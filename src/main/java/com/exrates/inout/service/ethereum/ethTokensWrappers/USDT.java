 ...
 */
public class USDT extends Contract implements ethTokenERC20{
    ...
    protected USDT(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected USDT(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
    ...
    public static RemoteCall<USDT> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit, BigInteger _initialSupply, String _name, String _symbol, BigInteger _decimals) {
        ...
        return deployRemoteCall(USDT.class, web3j, credentials, gasPrice, gasLimit, BINARY, encodedConstructor);
    }

    public static RemoteCall<USDT> deploy(Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit, BigInteger _initialSupply, String _name, String _symbol, BigInteger _decimals) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new Uint256(_initialSupply),
                new Utf8String(_name),
                new Utf8String(_symbol),
                new Uint256(_decimals)));
        return deployRemoteCall(USDT.class, web3j, transactionManager, gasPrice, gasLimit, BINARY, encodedConstructor);
    }
    ...
    public Observable<DeprecateEventResponse> deprecateEventObservable(EthFilter filter) {
    ...
    public static USDT load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new USDT(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    public static USDT load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
