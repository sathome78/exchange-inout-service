...
public class Privat24ServiceImpl implements Privat24Service {
    ...
    String url;
    private @Value("${privat24.merchant}")
    String merchant;
    private @Value("${privat24.details}")
    String details;
    private @Value("${privat24.ext_details}")
    String ext_details;
    private @Value("${privat24.pay_way}")
    String pay_way;
    private @Value("${privat24.return_url}")
    String return_url;
    private @Value("${privat24.server_url}")
    String server_url;
    private @Value("${privat24.password}")
    String password;
