...
public interface ErrorApiTitles {
    ...
    String MARKET_ORDER_ACCEPTING_FAILED = "MARKET_ORDER_ACCEPTING_FAILED";
    ...
    String KYC_NOT_PROCESSING = "KYC_NOT_PROCESSING";
    String QUBERA_USER_DATA_NOT_SAVED = "QUBERA_USER_DATA_NOT_SAVED";
    String QUBERA_PAYMENT_NOT_CONFIFM = "QUBERA_PAYMENT_NOT_CONFIFM";
    String QUBERA_EXTERNAL_PAYMENT_ERROR = "QUBERA_EXTERNAL_PAYMENT_ERROR";
    String QUBERA_PAYMENT_TYPE_ERROR = "QUBERA_PAYMENT_TYPE_ERROR";
    String QUBERA_PAYMENT_FIRST_OR_LAST_NAME_NULL = "QUBERA_PAYMENT_FIRST_OR_LAST_NAME_NULL";
    String QUBERA_PDF_ERROR_GENERATING = "QUBERA_PDF_ERROR_GENERATING";
    String QUBERA_CHECK_VERIFICATION_ERROR = "QUBERA_CHECK_VERIFICATION_ERROR";
    String QUBERA_UNKNOWN_KYC_STATUS = "QUBERA_UNKNOWN_KYC_STATUS";

    String FREE_COINS_GIVE_AWAY_PROCESS_FAILED = "FREE_COINS_GIVE_AWAY_PROCESS_FAILED";
    String FREE_COINS_RECEIVE_PROCESS_FAILED = "FREE_COINS_RECEIVE_PROCESS_FAILED";

    String REQUEST_DATA_NOT_VALID = "FREE_COINS_GIVE_AWAY_REQUEST_DATA_NOT_VALID";
    String NOT_AUTHORIZED = "NOT_AUTHORIZED";

    String AD_GROUP_ERROR_HTTP_CLIENT = "AD_GROUP_ERROR_HTTP_CLIENT";
    String AD_GROUP_HTTP_CLIENT_RESPONSE_NOT_200 = "AD_GROUP_HTTP_CLIENT_RESPONSE_NOT_200";
}